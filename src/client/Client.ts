import { DiscordTS, DiscordTSOptions } from "./constant/DENO.ts";
import { WebSocketManager } from "./sockets/MANAGER.ts";
import { ReqHandler } from "./rest/REQ_HANDLER.ts";
import * as Constructor from "./constructors/EXPORTS.ts";
...
export class Client {
  ...
  constructor(options: DiscordTSOptions) {
